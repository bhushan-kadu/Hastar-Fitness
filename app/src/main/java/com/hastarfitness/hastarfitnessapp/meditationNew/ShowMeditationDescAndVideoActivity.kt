...
class ShowMeditationDescAndVideoActivity : YouTubeBaseActivity() {
        ...
        mOnInitializedListener = object : YouTubePlayer.OnInitializedListener {
            override fun onInitializationSuccess(p0: YouTubePlayer.Provider?, p1: YouTubePlayer?, wasRestored: Boolean) {
                ...
                play_button.setOnClickListener {
                    this@ShowMeditationDescAndVideoActivity.playPauseBtnClick()
                }
            }
    ...
    private fun setView() {
        ...
        exerciseUrlHash = yogaExercise[position].img.split("?")[1].split("&")[0].split("=")[1]
