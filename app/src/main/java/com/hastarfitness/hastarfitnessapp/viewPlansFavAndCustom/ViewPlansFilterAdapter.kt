...
class ViewPlansFilterAdapter(private val workoutPlansFilterList: List<String>, private val myWorkoutPlansListAdapter: ViewPlansAdapter) : RecyclerView.Adapter<ViewPlansFilterAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewPlansFilterAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewPlansFilterAdapter.ViewHolder, position: Int) {
