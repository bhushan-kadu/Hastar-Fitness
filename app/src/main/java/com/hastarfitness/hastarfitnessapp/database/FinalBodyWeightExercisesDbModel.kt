...
data class FinalBodyWeightExercisesDbModel (
        ...
        companion object CREATOR : Parcelable.Creator<FinalBodyWeightExercisesDbModel> {
                override fun createFromParcel(parcel: Parcel): FinalBodyWeightExercisesDbModel {
                        return FinalBodyWeightExercisesDbModel(parcel)
                }

                override fun newArray(size: Int): Array<FinalBodyWeightExercisesDbModel?> {
